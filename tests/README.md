...
| `cases/25_check_interval_validation.sh` | `CHECK_INTERVAL` values the monitoring loop can actually be paced by |
...
└── mocks/                          fake ipmitool and sleep, put first in the PATH
```
