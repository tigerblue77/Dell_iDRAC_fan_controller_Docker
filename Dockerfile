...
ENV ENABLE_CPU_TEMPERATURE_FAN_CURVE=false
ENV CPU_TEMPERATURE_FAN_CURVE_LOW_THRESHOLD=60
ENV CPU_TEMPERATURE_FAN_CURVE_LOW_FAN_SPEED=12
ENV CPU_TEMPERATURE_FAN_CURVE_MID_THRESHOLD=75
ENV CPU_TEMPERATURE_FAN_CURVE_MID_FAN_SPEED=20
