...
# fan speed is exactly the wrong thing to be holding: Dell rates the PowerEdge line for 35°C intake,
# 40°C continuously on Fresh Air compliant models and 45°C for up to 1% of annual operating hours.
# Past the configured limit, iDRAC's own profile knows the platform's airflow requirements better
# than a fixed percentage does.
#
